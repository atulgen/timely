...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100 disabled:to-neutral-100 disabled:text-neutral-300 border border-neutral-200 shadow-sm [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        primary:
          "bg-gradient-to-b from-indigo-500 to-indigo-600 text-primary-foreground hover:from-indigo-600 hover:to-indigo-700",
        destructive:
          "bg-gradient-to-b from-rose-500 to-rose-700 text-destructive-foreground hover:from-rose-600 hover:to-rose-700",
        outline:
          "border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground",
        secondary: "bg-white hover:bg-neutral-100 text-slate-800",
        ghost:
          "border-transparent shadow-none hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        muted: "bg-neutral-200 text-neutral-600 hover:bg-neutral-200/80",
        teritrary:
          "bg-indigo-100 text-indigo-600 border-transparent hover:bg-indigo-200 shadow-none",
      },
      size: {
